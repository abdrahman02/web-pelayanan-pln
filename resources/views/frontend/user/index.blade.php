        ...
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12 col-xl-6">
                <div class="d-flex flex-wrap align-items-center">
                    <div class="profile-img-main rounded" style="margin-right: 10px">
                        @if (!empty($user->image))
                        ...
                        @else
                        <img src="{{ asset('img/6.jpg') }}" alt="img" class="m-0 p-1 rounded" style="max-width: 250px;">
                        @endif
                    </div>
                    <div class="ms-4">
                        <h4>{{ auth()->user()->name }}</h4>
                        <p class="text-muted mb-2">Member Since: {{ auth()->user()->created_at->format('d-M-Y') }}</p>
                        <div class="badge badge-primary"><i class="mdi mdi-account-star"></i> {{ auth()->user()->role
                            }}</div>
                    </div>
                </div>
            </div>
        ...
        <div class="wideget-user-tab">
            <div class="tab-menu-heading">
                <div class="tabs-menu1">
                    <ul class="nav">
                        <li><a href="#accountSettings" class="active show" data-toggle="tab">Account Settings</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="tab-content mx-5">
    <div class="tab-pane active show" id="accountSettings">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('pengguna.update', $user->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        <div class="row row-sm">
                            ...
                            <div class="col-md-9">
                                ...
                                <input class="form-control mb-4 @error('image') is-invalid @enderror" type="file"
                    ...
                    <div class="form-group float-right">
                        <div class="row row-sm">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-info my-1" href="#" data-toggle="modal"
                                    data-target="#modal-ubh-password{{ auth()->user()->id }}">Change Password</a>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pengguna.update',$id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <label for="password_lama"
                                class="col-sm-2 col-lg-12 col-form-label font-weight-bold">Password
                                Lama</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <label for="password" class="col-sm-2 col-lg-12 col-form-label font-weight-bold">Password
                                Baru</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <label for="password_confirmation"
                                class="col-sm-2 col-lg-12 col-form-label font-weight-bold">Konfirmasi Password
                                Baru</label>
